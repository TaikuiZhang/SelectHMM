...
print "\nCheck Genome-Protein Sequences: Done. See $gfile.\n";
...
while(<P>){
	...
	my ($q1,$q2,$q3,$q4,$q5)=split(/[\s]+/,$s4,5);
...
close P;
close L;
print "\nSummary HMMStat: Done. See $file.Stat.txt.\n";
move("$file.Stat.txt", "SelectHMM_Out");
$t++;

#open(R, ">Final_Protein.fa") or die $!;
system ("perl ExtractSequence.pl $gfile Final_Protein.fa");
#close R;
#close L;
...
print "\nZhang TK, Liu CY, Zhang HY, Yuan ZH (2017).An integrated approach to identify Cytochrome P450 superfamilies in plant species within the Malvids. In: Proceedings of 2017 5th international conference on bioinformatics and computational biology. Zhang D eds. New York: ACM. Pp.11-16.\n\n";
